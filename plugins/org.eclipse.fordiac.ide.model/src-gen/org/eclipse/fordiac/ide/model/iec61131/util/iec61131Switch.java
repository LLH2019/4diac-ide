...
public class iec61131Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case iec61131Package.PROGRAM: {
			...
			if (result == null)
				result = caseFBType(program);
			if (result == null)
				result = caseCompilableType(program);
			if (result == null)
				result = caseLibraryElement(program);
			if (result == null)
				result = caseINamedElement(program);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case iec61131Package.PROGRAM_INSTANCE: {
			ProgramInstance programInstance = (ProgramInstance) theEObject;
			T result = caseProgramInstance(programInstance);
			if (result == null)
				result = caseFB(programInstance);
			if (result == null)
				result = caseFBNetworkElement(programInstance);
			if (result == null)
				result = caseTypedConfigureableObject(programInstance);
			if (result == null)
				result = casePositionableElement(programInstance);
			if (result == null)
				result = caseConfigurableObject(programInstance);
			if (result == null)
				result = caseINamedElement(programInstance);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Program
	 * Instance</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Program
	 *         Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgramInstance(ProgramInstance object) {
		return null;
	}

...
public class LibraryElementPackageImpl extends EPackageImpl implements LibraryElementPackage {
	 ...
	 * @generated
	 */
	private EClass inheritableAttributeEClass = null;
	 ...
	 */
	@Override
	public EClass getInheritableAttribute() {
		return inheritableAttributeEClass;
	}
	 ...
	 */
	@Override
	public EReference getInheritableAttribute_AttributeDeclarations() {
		return (EReference)inheritableAttributeEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		inheritableAttributeEClass = createEClass(INHERITABLE_ATTRIBUTE);
		createEReference(inheritableAttributeEClass, INHERITABLE_ATTRIBUTE__ATTRIBUTE_DECLARATIONS);
	...
	public void initializePackageContents() {
		...
		deviceTypeEClass.getESuperTypes().add(this.getInheritableAttribute());
		...
		iInterfaceElementEClass.getESuperTypes().add(this.getInheritableAttribute());
		...
		initEClass(inheritableAttributeEClass, InheritableAttribute.class, "InheritableAttribute", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(getInheritableAttribute_AttributeDeclarations(), this.getAttributeDeclaration(), null, "attributeDeclarations", null, 0, -1, InheritableAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(inheritableAttributeEClass, null, "setAttributeDeclaration", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getString(), "type", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getString(), "initialValue", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getString(), "comment", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(inheritableAttributeEClass, this.getAttributeDeclaration(), "getAttributeDeclaration", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, theXMLTypePackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

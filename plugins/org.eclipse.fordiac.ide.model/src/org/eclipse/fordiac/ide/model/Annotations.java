...
public final class Annotations {
	...
	public static void setAttributeDeclaration(InheritableAttribute object, final String name, final String type, final String initialValue, final String comment) {
	...
	public static AttributeDeclaration getAttributeDeclaration(InheritableAttribute object, final String name) {
		if (name == null) {
			return null;
		}
